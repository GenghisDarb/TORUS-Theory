...
\item
  ...
  \item
    ...
    below \textasciitilde{}10\superscript{−15} of the speed of light for
    ...
    $10\superscript{−16}$--$10\superscript{−21}$ level} (fractional speed
    difference) over cosmological distances, then TORUS's dispersion
    effect is ruled out or forced to extremely small values​. Conversely, detecting even a minute frequency-dependent arrival
...
\item
  ...
  \item
    ...
    correct, the effective $H\subscript{0}$ might differ depending on scale or
    epoch. Strategy: measure $H\subscript{0}$ independently with new methods
  ...
  \item
    ...
    If all these data show \textbf{$w = -1.000 (\pm 0.005)$} with no hint of
...
\item
  ...
  \item
    ...
    (supernovae $H\subscript{0}$ measurements) and early data from \textbf{Rubin
...
\item
  ...
  \item
    ...
    corrections to below $10\superscript{−7}$ (for coherence) and below $10\superscript{−5}$
  ...
  \item
    ...
    evolution. By \textasciitilde{}2030, either find evidence of $w \neq -1$
    or conclude it's constant to within \textasciitilde{}1\%​. Also by
    \textasciitilde{}2030, resolve the
    $S\subscript{8}$
    tension
    (either it persists at >3$\sigma$ or is explained by improved
    ...
    persistent $S\subscript{8}$ anomaly, or a CMB polarization-axis
    detection would each be a ``win'' for TORUS, to be reported in
    high-profile publications as potential evidence of new physics.
    Conversely, if surveys show \emph{no} deviations -- e.g. $w = -1.000 \pm 0.003$, structure formation exactly as $\Lambda$CDM, and no CMB anomalies -- then by 2030 TORUS's cosmological predictions would be largely falsified or forced into the realm of undetectably small effects.
  \item
