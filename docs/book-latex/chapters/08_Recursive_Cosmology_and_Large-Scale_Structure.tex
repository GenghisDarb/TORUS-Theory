...
=======
  ...
  where cosmic shear surveys see a bit less clustering than 
  ...
  spectrum features} that are not expected in pure ​. This could
  ...
  structure growth perfectly matches a  universe with cold dark
...
\item
  ...
  (aside from very early universe scenarios).  inherits this
...
=======
  ...
  In contrast,  (and standard particle physics) would struggle to
...
\item
  \textbf{Cosmic topology and large-angle anomalies:}  usually
  ...
  motion. These are not definitive cracks in , but they are puzzling
...
explained by  -- it would breathe new life into the recursion idea.
...
=======
  ...
  (the  value). If TORUS's recursion causes a slight evolution of w
...
recursion}, TORUS provides a daring alternative to : one that
