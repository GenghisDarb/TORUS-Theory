...
% Unicode character declarations for PDFLaTeX
\DeclareUnicodeCharacter{039B}{\Lambda} % Greek capital Lambda
\DeclareUnicodeCharacter{0127}{\hbar}  % Planck constant
\DeclareUnicodeCharacter{03B1}{\alpha} % Greek small alpha
\DeclareUnicodeCharacter{2248}{\approx} % Approximately equal
\DeclareUnicodeCharacter{2212}{-} % Minus sign
\DeclareUnicodeCharacter{2113}{\ell} % Script small l
\usepackage{iftex}
\ifPDFTeX
