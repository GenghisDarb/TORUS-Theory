...
\item
  ...
  \item
    ...
    ΛCDM with constant dark energy would allow could signal TORUS
    effects​.
  \item
    ...
    TORUS's model over ΛCDM. \textbf{Falsifiability:} TORUS can be
...
\item
  ...
  value inferred from the CMB assuming ΛCDM. TORUS predicts a possible
  ...
  \item
    ...
    perfectly in line with ΛCDM and general relativity when accounting
...
\item
  ...
  \item
    ...
    as ΛCDM, and no CMB anomalies -- then by 2030 TORUS's cosmological
