...
associated with the dimensionless fine-structure constant α (the seed
...
example, the tiny value of the 0D coupling α is directly tied to the
...
\item
  ...
  equation-of-state deviates from w = --1 (the ΛCDM value). If TORUS's
